...
public class MastermindRun {
    ...
    private static String[] messages = {"Game/World over... - Skynet", "You should have taken the red pill.", "YOU ARE DOING IT WRONG!",
            "Thank you, now keep enjoying your crappy Windows :D", "Not feeling lucky any more punk?", "SE ACA-VOS!"};
